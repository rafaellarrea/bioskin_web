...
export const services: Service[] = [
  ...
  {
    "id": "skin-booster",
    "title": "Skin Booster (Ácido Hialurónico + Exosomas)",
    "shortDescription": "Hidratación profunda y regeneración celular",
    "description": "Tratamiento avanzado de revitalización cutánea que combina ácido hialurónico de bajo peso molecular con el poder regenerativo de los exosomas. Mejora la hidratación, elasticidad y luminosidad de la piel desde las capas profundas.",
    ...
    "benefits": [
      ...
      "Regeneración celular mediante exosomas"
    ],
    "indications": [
      "Pieles deshidratadas o apagadas",
