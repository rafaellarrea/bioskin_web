        ...
        <div className='container-custom px-6 relative z-10'>
          ...
          <div className='grid lg:grid-cols-2 gap-12'>
            ...
            <div className='space-y-6'>
              ...
              >
                ...
                <ul className='space-y-2 font-mono text-xs text-gray-500'>
                  <li className='flex items-center'><span className='text-[#deb887] mr-2'>?</span> Calibración energética</li>
                  <li className='flex items-center'><span className='text-[#deb887] mr-2'>?</span> Limpieza de óptica interna</li>
                  <li className='flex items-center'><span className='text-[#deb887] mr-2'>?</span> Certificación de estado</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul className='space-y-2 font-mono text-xs text-gray-500'>
                  <li className='flex items-center'><span className='text-red-500 mr-2'>?</span> Microelectrónica</li>
                  <li className='flex items-center'><span className='text-red-500 mr-2'>?</span> Ajuste de cavidades láser</li>
                  <li className='flex items-center'><span className='text-red-500 mr-2'>?</span> Recuperación de enfriamiento</li>
                </ul>
              </motion.div>
            </div>
            ...
            >
              ...
              <a 
                href={https://wa.me/?text=Hola,%20me%20interesa%20información%20sobre%20ventas%20BIOSKIN%20TECH}
                target='_blank'
      ...
      <section className='py-20 bg-[#050505] border-t border-gray-900 relative overflow-hidden'>
        ...
        <div className='container-custom px-6 text-center relative z-10'>
          ...
          <div className='flex flex-col md:flex-row items-center justify-center gap-6'>
            <a 
              href={https://wa.me/?text=Hola,%20necesito%20soporte%20técnico%20BIOSKIN%20TECH} 
            ...
            <a 
              href={https://wa.me/?text=Hola,%20me%20interesa%20comprar%20equipos%20médicos}
...
const TechCard = ({ icon, title, subtitle, description, borderColor, glow = false }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className={g-[#0f0f0f] p-8 border border-gray-800 relative group overflow-hidden }
  >
    <div className={bsolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-current to-transparent opacity-50 }></div>
    ...
    <p className={	ext-xs font-mono mb-4 uppercase tracking-widest }>{subtitle}</p>
    
    <p className='text-gray-400 text-sm leading-relaxed relative z-10'>{description}</p>
    
    {/* Hover Effect Background */}
    <div className={bsolute inset-0 bg-gradient-to-br  to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none}></div>
  </motion.div>
);
