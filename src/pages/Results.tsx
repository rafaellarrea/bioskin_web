  ...
  return (
    <section id="results" className="py-24">
      <div className="container-custom">
        ...
        <div className="mb-20">
          <h3 className="text-2xl font-semibold text-center mb-10 animate-fade-in" data-aos="fade-up">Antes y Después</h3>
          ...
          <p className="text-sm text-gray-500 text-center mt-6 animate-fade-in" data-aos="fade-up">
            *Fotos con fines ilustrativos. Los resultados pueden variar según las características individuales.
          </p>
        </div>
        
        <div>
          <h3 className="text-2xl font-semibold text-center mb-10 animate-fade-in" data-aos="fade-up">Testimonios de Clientes</h3>
