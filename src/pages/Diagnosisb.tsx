    ...
    <section id="diagnosis" className="py-24 bg-gray-50">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col justify-center animate-fade-in" data-aos="fade-left">
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-semibold text-center mb-12 animate-fade-in" data-aos="fade-up">Nuestro Proceso</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md text-center animate-fade-in" data-aos="fade-up" data-aos-delay={index * 100}>
