          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-blue-800 mb-3">🌍 Sistema de Analytics Híbrido</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg p-4 border border-blue-100">
                      <h4 className="font-semibold text-blue-700 mb-2">📊 Datos Demo (Mostrados Aquí)</h4>
                      <ul className="text-sm text-blue-600 space-y-1">
                        <li>• Almacenamiento: localStorage del navegador</li>
                        <li>• Alcance: Solo este navegador específico</li>
                        <li>• Duración: Hasta limpiar cache</li>
                        <li>• Propósito: Demostración de funcionalidad UI</li>
                      </ul>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-green-100">
                      <h4 className="font-semibold text-green-700 mb-2">🌐 Datos Reales (Vercel Analytics)</h4>
                      <ul className="text-sm text-green-600 space-y-1">
                        <li>• Almacenamiento: Servidores Vercel (nube global)</li>
                        <li>• Alcance: Visitantes de todo el mundo</li>
                        <li>• Duración: Permanente, historial completo</li>
                        <li>• Visitantes únicos: Reales y cross-browser</li>
                      </ul>
                    </div>
                  </div>
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-700">
                      <strong>📋 Funcionamiento:</strong> Cada visita desde cualquier navegador del mundo se registra en Vercel Analytics. 
                      Los conteos NO se resetean automáticamente - son acumulativos. Para datos precisos de visitantes únicos y 
                      métricas profesionales, consulta el dashboard oficial de Vercel Analytics.
                    </p>
                    <a 
                    ...
                    >
                      📈 Ver Analytics Reales (Vercel Dashboard)
            ...
            {/* Estadísticas Demo (localStorage) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Últimos 7 días */}
              <div className="bg-white p-6 rounded-lg shadow border-l-4 border-blue-300">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold">Últimos 7 Días</h3>
                  <span className="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">Demo Local</span>
                </div>
                <div className="space-y-3">
                  {!loadingAnalytics && analyticsStats ? (
                    Object.entries(analyticsStats.total.pageViews || {}).slice(-7).map(([date, views], index) => (
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="w-16 bg-gray-200 rounded-full h-2 mt-1">
                            <div 
                              ...
                              style={{ 
                                width: `${Math.min(100, (views / Math.max(...Object.values(analyticsStats.total.pageViews || {}), 1)) * 100)}%` 
                              }}
                            ></div>
                          </div>
                        </div>
