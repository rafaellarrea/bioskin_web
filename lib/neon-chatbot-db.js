...
// IMPORTANTE: Desactivar WebSocket y usar HTTP (fetch) para Vercel
// WebSocket tiene problemas de timeout en funciones serverless
neonConfig.useSecureWebSocket = false;
neonConfig.pipelineConnect = false;

// Conexión a Neon PostgreSQL (usará HTTP fetch automáticamente)
const sql = neon(process.env.NEON_DATABASE_URL);

console.log('✅ Cliente Neon inicializado (HTTP mode)');
