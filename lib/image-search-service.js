...
export function generateBlogImage(blog) {
  ...
  try {
    ...
    // ✅ PRIORIDAD 1: Si hay descripción visual generada por IA, usarla
    ...
    console.log(`🖼️ Generated image for blog "${title}":`, imageUrl);
    
    return {
      url: imageUrl,
      keywords: keywords,
      attribution: 'Photo by Unsplash contributors',
      source: visualDescription ? 'ai-description' : 'content-analysis'
    };
