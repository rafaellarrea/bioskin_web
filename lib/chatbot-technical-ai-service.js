...
Tono: Profesional, servicial, sin presionar.`;
    ...
    // PASO 2: Verificar si es pregunta sobre SERVICIO TÉCNICO (soporte, instalación, garantía)
    // Esto es DIFERENTE a preguntar por equipos específicos
    const isServiceInquiry = /(ofrecen|tienen|dan|brindan|hay).*servicio.*t[eé]cnico/i.test(lastUserMsg) ||
    ...
    if (isServiceInquiry) {
      ...
      return {
        responseText: `Sí, ofrecemos servicio técnico completo para todos nuestros equipos médicos estéticos. Esto incluye instalación, mantenimiento y soporte postventa. 🔧\n\n¿Le gustaría conocer más detalles sobre este servicio?`,
        suggestedActions: ['provide_service_details'],
        meta: {
