...
export async function analyzeInvoiceImage(imageBuffer, mimeType = "image/jpeg") {
  ...
  // Actualizado Mar 2026: Removidos modelos experimentales que causan 404
  const models = [
    "gemini-1.5-flash",        // Standard rápido
    "gemini-1.5-flash-latest", // Última versión estable de flash
    "gemini-1.5-pro",          // Más potente para facturas complejas
    "gemini-1.0-pro",          // Fallback legacy confiable
    "gemini-pro"               // Alias genérico final
  ];
