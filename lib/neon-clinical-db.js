...
if (!process.env.NEON_DATABASE_URL) {
  console.warn('⚠️ NEON_DATABASE_URL no está configurada. La funcionalidad de Fichas Clínicas no funcionará correctamente.');
}

// Use the environment variable or a hardcoded fallback for testing if absolutely necessary (not recommended for production)
// But here we just ensure we use the env var.
