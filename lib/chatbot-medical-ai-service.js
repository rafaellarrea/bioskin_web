...
🔍 **IMPORTANTE - Reconocimiento de tratamientos:**
   → Si usuario menciona "bioestimuladores", busca en el catálogo:
     - "Bioestimuladores de Colágeno" (inyectables)
     - "HIFU 7D" (bioestimulador NO invasivo)
     - "Microneedling" (estimula colágeno)
   → NO digas que no tienes el tratamiento sin buscar en TODO el catálogo
   → Usa las keywords de cada servicio para encontrar coincidencias
   → Si usuario da detalles adicionales, úsalos para refinar búsqueda
