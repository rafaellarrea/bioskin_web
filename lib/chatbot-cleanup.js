// Importar la nueva versión HTTP
import { getDatabaseStats } from './neon-chatbot-db-http.js';

// Helper function para ejecutar queries (reutilizando la lógica de neon-chatbot-db-http.js)
